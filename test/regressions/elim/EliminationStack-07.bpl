...
$bb5:
  $p4 := $p1;
  $p5 := $pa($pa(location, 0, 112), $p4, 8);
  $M.5[$p5] := p;
  call $p6 := GetPosition(p);
  $p7 := $p6;
  $p8 := $pa($pa(collision, 0, 16), $p7, 4);
  $p9 := $M.6[$p8];
  $p10 := $p9;
  goto $bb6;
$bb6:
  $p11 := $p6;
  $p12 := $pa($pa(collision, 0, 16), $p11, 4);
  call $b13 := int_cas($p12, $p10, $p1);
  $b14 := $i2b($xor($b2i($b13), $b2i(true)));
  goto $bb9, $bb10;
$bb7:
  $p44 := $p6;
  $p45 := $pa($pa(collision, 0, 16), $p44, 4);
  $p46 := $M.6[$p45];
  $p10 := $p46;
  goto $bb6;
$bb8:
...
$bb11:
  $p21 := $p10;
  $p22 := $pa($pa(location, 0, 112), $p21, 8);
  $p23 := $M.5[$p22];
  $b24 := ($p23 != 0);
  goto $bb22, $bb23;
$bb12:
  $p16 := $pa($pa(p, 0, 32), 24, 1);
  $p17 := $M.0[$p16];
  call delay($p17);
  assume {:yield} true;
  $p18 := $p1;
  $p19 := $pa($pa(location, 0, 112), $p18, 8);
  call $b20 := ti_cas($p19, p, 0);
  goto $bb17, $bb18;
$bb13:
  assume $b15;
  goto $bb11;
...
$bb23:
  ...
  goto $bb21;
$bb24:
  $p28 := $pa($pa($p23, 0, 32), 4, 1);
  $p29 := $M.0[$p28];
  $p30 := $p29;
  $p31 := $pa($pa(p, 0, 32), 4, 1);
  $p32 := $M.0[$p31];
  $p33 := $p32;
  $b34 := ($p30 != $p33);
  goto $bb28, $bb29;
...
$bb27:
  assume {:yield} true;
  $p35 := $p1;
  $p36 := $pa($pa(location, 0, 112), $p35, 8);
  call $b37 := ti_cas($p36, p, 0);
  goto $bb32, $bb33;
$bb28:
  assume $b34;
  goto $bb27;
$bb29:
  ...
  goto $bb21;
$bb30:
  call $b38 := TryCollision(p, $p23, $p10);
  $p39 := $b2p($b38);
  $b40 := ($p39 == 1);
  goto $bb36, $bb37;
$bb31:
