// @c2s-options --unroll 1 --delays 3 --rounds 3
...
function $isExternal(p: int) returns (bool) { p < -38159 }
const $GLOBALS_BOTTOM: int;
axiom $GLOBALS_BOTTOM == -5391;
...
$bb0:
  ...
  assume {:round t1, "Y", 1, 0} true;
  assume {:round t1, "X", 1, 0} true;
  assume {:round t2, "Y", 1, 0} true;
  assume {:round t2, "X", 1, 0} true;
  assume {:round t3, "Y", 1, 0} true;
  assume {:round t3, "X", 1, 1} true;
  assume {:round t4, "Y", 1, 0} true;
  assume {:round t4, "X", 1, 0} true;
