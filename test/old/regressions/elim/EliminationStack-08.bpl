...
$bb6:
  ...
  call $b11 := int_cas($p10, $p8, $p1);
  $b12 := $i2b($xor($b2i($b11), $b2i(true)));
  goto $bb9, $bb10;
$bb7:
  $p42 := $p4;
  $p43 := $pa($pa(collision, 0, 16), $p42, 4);
  $p44 := $M.6[$p43];
  $p8 := $p44;
  goto $bb6;
$bb8:
...
$bb23:
  ...
  goto $bb21;
$bb24:
  $p26 := $pa($pa($p21, 0, 32), 4, 1);
  $p27 := $M.0[$p26];
  $p28 := $p27;
  $p29 := $pa($pa(p, 0, 32), 4, 1);
  $p30 := $M.0[$p29];
  $p31 := $p30;
  $b32 := ($p28 != $p31);
  goto $bb28, $bb29;
...
$bb29:
  ...
  goto $bb21;
$bb30:
  call $b36 := TryCollision(p, $p21, $p8);
  $p37 := $b2p($b36);
  $b38 := ($p37 == 1);
  goto $bb36, $bb37;
$bb31:
