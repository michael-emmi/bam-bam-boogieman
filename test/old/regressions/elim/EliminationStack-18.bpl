...
$bb3:
  $p46 := $p4;
  $p47 := $pa($pa(collision, 0, 16), $p46, 4);
  $p48 := $M.6[$p47];
  $p8 := $p48;
  goto $bb2;
$bb4:
...
$bb7:
  $p23 := $p8;
  $p24 := $pa($pa(location, 0, 112), $p23, 8);
  $p25 := $M.5[$p24];
  $b26 := ($p25 != 0);
  goto $bb25, $bb26;
$bb8:
...
$bb11:
  $p19 := $p1;
  $p20 := $pa($pa(location, 0, 112), $p19, 8);
  $p21 := $M.5[$p20];
  $b22 := ($p21 != p);
  goto $bb21, $bb22;
$bb12:
  $p16 := $p1;
  $p17 := $pa($pa(location, 0, 112), $p16, 8);
  call $b18 := ti_cas($p17, p, 0);
  goto $bb17, $bb18;
$bb13:
  assume $b15;
  goto $bb11;
...
$bb26:
  ...
  goto $bb24;
$bb27:
  $p30 := $pa($pa($p25, 0, 32), 4, 1);
  $p31 := $M.0[$p30];
  $p32 := $p31;
  $p33 := $pa($pa(p, 0, 32), 4, 1);
  $p34 := $M.0[$p33];
  $p35 := $p34;
  $b36 := ($p32 != $p35);
  goto $bb31, $bb32;
...
$bb30:
  assume {:yield} true;
  $p37 := $p1;
  $p38 := $pa($pa(location, 0, 112), $p37, 8);
  call $b39 := ti_cas($p38, p, 0);
  goto $bb35, $bb36;
$bb31:
  assume $b36;
  goto $bb30;
$bb32:
  ...
  goto $bb24;
$bb33:
  call $b40 := TryCollision(p, $p25, $p8);
  $p41 := $b2p($b40);
  $b42 := ($p41 == 1);
  goto $bb39, $bb40;
$bb34:
