...
$bb3:
  $p41 := $p4;
  $p42 := $pa($pa(collision, 0, 16), $p41, 4);
  $p43 := $M.6[$p42];
  $p8 := $p43;
  goto $bb2;
$bb4:
...
$bb23:
  assume {:yield} true;
  $p32 := $p1;
  $p33 := $pa($pa(location, 0, 112), $p32, 8);
  call $b34 := ti_cas($p33, p, 0);
  goto $bb28, $bb29;
$bb24:
  assume $b31;
  goto $bb23;
$bb25:
  ...
  goto $bb17;
$bb26:
  call $b35 := TryCollision(p, $p20, $p8);
  $p36 := $b2p($b35);
  $b37 := ($p36 == 1);
  goto $bb32, $bb33;
$bb27:
...
$bb0:
  ...
  goto $bb3, $bb4;
$bb1:
  $p26 := $M.3[$pa($pa(S, 0, 8), 0, 1)];
  $p27 := $pa($pa(p, 0, 32), 8, 1);
  $p28 := $pa($pa($p27, 0, 16), 0, 1);
  $M.0[$p28] := $p26;
  assume {:yield} true;
  $p29 := $pa($pa(p, 0, 32), 8, 1);
  call $b30 := c_cas($pa($pa(S, 0, 8), 0, 1), $p26, $p29);
  goto $bb24, $bb25;
$bb2:
  $p3 := $pa($pa(p, 0, 32), 4, 1);
  $p4 := $M.0[$p3];
...
$bb14:
  ...
  goto $bb9;
$bb15:
  $p13 := $pa($pa($p11, 0, 16), 0, 1);
  $p14 := $M.0[$p13];
  assume {:yield} true;
  call $b15 := c_cas($pa($pa(S, 0, 8), 0, 1), $p11, $p14);
  goto $bb20, $bb21;
$bb16:
  assume $b12;
  goto $bb14;
...
$bb18:
  ...
  goto $bb9;
$bb19:
  $p16 := $M.2[$pa($pa(EMPTY, 0, 16), 8, 1)];
  $p17 := $pa($pa(p, 0, 32), 8, 1);
